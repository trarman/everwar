...
BaseZoneMapServiceServiceService = new WSDLService("BaseZoneMapServiceServiceService");
            ...
            BaseZoneMapServiceServiceService.getPort("BaseZoneMapServiceServicePort").binding.portType.addOperation(updateZoneMapById);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","addZoneMap"),com.beacon.maps.AddZoneMap);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","getZoneMapByIdResponse"),com.beacon.maps.GetZoneMapByIdResponse);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","getZones"),com.beacon.maps.GetZones);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","updateZoneMapById"),com.beacon.maps.UpdateZoneMapById);
							SchemaTypeRegistry.getInstance().registerCollectionClass(new QName("http://map.ws.editor.rpg.beacon.com/","getZonesResponse"),com.beacon.maps.GetZonesResponse);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","mapObject"),com.beacon.maps.MapObject);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","updateZoneMapByIdResponse"),com.beacon.maps.UpdateZoneMapByIdResponse);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","zoneMapListItem"),com.beacon.maps.ZoneMapListItem);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","addZoneMapResponse"),com.beacon.maps.AddZoneMapResponse);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","getZoneMapById"),com.beacon.maps.GetZoneMapById);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","zoneMap"),com.beacon.maps.ZoneMap);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://map.ws.editor.rpg.beacon.com/","zoneCell"),com.beacon.maps.ZoneCell);
		}
		/**
