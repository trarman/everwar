...
BaseConversationServiceServiceService = new WSDLService("BaseConversationServiceServiceService");
            ...
            var saveConversationExchange:WSDLOperation = new WSDLOperation("saveConversationExchange");
				//input message for the operation
    	        requestMessage = new WSDLMessage("saveConversationExchange");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","saveConversationExchange"),null,new QName("http://conversation.ws.rpg.beacon.com/","saveConversationExchange")));
                requestMessage.encoding = new WSDLEncoding();
                requestMessage.encoding.namespaceURI="http://conversation.ws.rpg.beacon.com/";
			requestMessage.encoding.useStyle="literal";
                
                responseMessage = new WSDLMessage("saveConversationExchangeResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","saveConversationExchangeResponse"),null,new QName("http://conversation.ws.rpg.beacon.com/","saveConversationExchangeResponse")));
				...
				saveConversationExchange.inputMessage = requestMessage;
	        saveConversationExchange.outputMessage = responseMessage;
            saveConversationExchange.schemaManager = this.schemaMgr;
            saveConversationExchange.soapAction = "\"\"";
            saveConversationExchange.style = "document";
            BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.addOperation(saveConversationExchange);
			//define the WSDLOperation: new WSDLOperation(methodName)
            var getConversationStarters:WSDLOperation = new WSDLOperation("getConversationStarters");
				//input message for the operation
    	        requestMessage = new WSDLMessage("getConversationStarters");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","getConversationStarters"),null,new QName("http://conversation.ws.rpg.beacon.com/","getConversationStarters")));
                requestMessage.encoding = new WSDLEncoding();
                requestMessage.encoding.namespaceURI="http://conversation.ws.rpg.beacon.com/";
			requestMessage.encoding.useStyle="literal";
                
                responseMessage = new WSDLMessage("getConversationStartersResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","getConversationStartersResponse"),null,new QName("http://conversation.ws.rpg.beacon.com/","getConversationStartersResponse")));
                responseMessage.encoding = new WSDLEncoding();
                responseMessage.encoding.namespaceURI="http://conversation.ws.rpg.beacon.com/";
                responseMessage.encoding.useStyle="literal";				
				getConversationStarters.inputMessage = requestMessage;
	        getConversationStarters.outputMessage = responseMessage;
            getConversationStarters.schemaManager = this.schemaMgr;
            getConversationStarters.soapAction = "\"\"";
            getConversationStarters.style = "document";
            BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.addOperation(getConversationStarters);
			//define the WSDLOperation: new WSDLOperation(methodName)
            var saveConversationAnswer:WSDLOperation = new WSDLOperation("saveConversationAnswer");
				//input message for the operation
    	        requestMessage = new WSDLMessage("saveConversationAnswer");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","saveConversationAnswer"),null,new QName("http://conversation.ws.rpg.beacon.com/","saveConversationAnswer")));
                requestMessage.encoding = new WSDLEncoding();
                requestMessage.encoding.namespaceURI="http://conversation.ws.rpg.beacon.com/";
			requestMessage.encoding.useStyle="literal";
                
                responseMessage = new WSDLMessage("saveConversationAnswerResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","saveConversationAnswerResponse"),null,new QName("http://conversation.ws.rpg.beacon.com/","saveConversationAnswerResponse")));
                responseMessage.encoding = new WSDLEncoding();
                responseMessage.encoding.namespaceURI="http://conversation.ws.rpg.beacon.com/";
                responseMessage.encoding.useStyle="literal";				
				saveConversationAnswer.inputMessage = requestMessage;
	        saveConversationAnswer.outputMessage = responseMessage;
            saveConversationAnswer.schemaManager = this.schemaMgr;
            saveConversationAnswer.soapAction = "\"\"";
            saveConversationAnswer.style = "document";
            BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.addOperation(saveConversationAnswer);
			//define the WSDLOperation: new WSDLOperation(methodName)
            var removeConversationById:WSDLOperation = new WSDLOperation("removeConversationById");
				//input message for the operation
    	        requestMessage = new WSDLMessage("removeConversationById");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","removeConversationById"),null,new QName("http://conversation.ws.rpg.beacon.com/","removeConversationById")));
                requestMessage.encoding = new WSDLEncoding();
                requestMessage.encoding.namespaceURI="http://conversation.ws.rpg.beacon.com/";
			requestMessage.encoding.useStyle="literal";
                
                responseMessage = new WSDLMessage("removeConversationByIdResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://conversation.ws.rpg.beacon.com/","removeConversationByIdResponse"),null,new QName("http://conversation.ws.rpg.beacon.com/","removeConversationByIdResponse")));
                responseMessage.encoding = new WSDLEncoding();
                responseMessage.encoding.namespaceURI="http://conversation.ws.rpg.beacon.com/";
                responseMessage.encoding.useStyle="literal";				
				removeConversationById.inputMessage = requestMessage;
	        removeConversationById.outputMessage = responseMessage;
            removeConversationById.schemaManager = this.schemaMgr;
            removeConversationById.soapAction = "\"\"";
            removeConversationById.style = "document";
            BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.addOperation(removeConversationById);
			//define the WSDLOperation: new WSDLOperation(methodName)
		...
		public function saveConversationExchange(saveConversationExchange:SaveConversationExchange):AsyncToken
		{
            ...
            out["saveConversationExchange"] = saveConversationExchange;
	            currentOperation = BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.getOperation("saveConversationExchange");
		...
		public function getConversationStarters(getConversationStarters:GetConversationStarters):AsyncToken
		{
			var headerArray:Array = new Array();
            var out:Object = new Object();
            out["getConversationStarters"] = getConversationStarters;
	            currentOperation = BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.getOperation("getConversationStarters");
            var pc:PendingCall = new PendingCall(out,headerArray);
            call(currentOperation,out,pc.token,pc.headers);
            return pc.token;
		}
		...
		public function saveConversationAnswer(saveConversationAnswer:SaveConversationAnswer):AsyncToken
		{
			var headerArray:Array = new Array();
            var out:Object = new Object();
            out["saveConversationAnswer"] = saveConversationAnswer;
	            currentOperation = BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.getOperation("saveConversationAnswer");
            var pc:PendingCall = new PendingCall(out,headerArray);
            call(currentOperation,out,pc.token,pc.headers);
            return pc.token;
		}
		...
		public function removeConversationById(removeConversationById:RemoveConversationById):AsyncToken
		{
			var headerArray:Array = new Array();
            var out:Object = new Object();
            out["removeConversationById"] = removeConversationById;
	            currentOperation = BaseConversationServiceServiceService.getPort("BaseConversationServiceServicePort").binding.portType.getOperation("removeConversationById");
            var pc:PendingCall = new PendingCall(out,headerArray);
            call(currentOperation,out,pc.token,pc.headers);
            return pc.token;
		}
