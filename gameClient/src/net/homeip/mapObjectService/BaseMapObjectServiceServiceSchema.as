package net.homeip.mapObjectService
{
    ...
    <xsd:element name="getMapObjectById" type="tns:getMapObjectById"/>
    <xsd:element name="getMapObjectByIdResponse" type="tns:getMapObjectByIdResponse"/>
    ...
    <xsd:complexType name="getMapObjectById">
        <xsd:sequence>
            <xsd:element minOccurs="0" name="id" type="xs:int"/>
        </xsd:sequence>
    </xsd:complexType>
    <xsd:complexType name="getMapObjectByIdResponse">
        <xsd:sequence>
