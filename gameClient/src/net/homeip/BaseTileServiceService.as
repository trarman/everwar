...
BaseTileServiceServiceService = new WSDLService("BaseTileServiceServiceService");
            ...
            BaseTileServiceServiceService.getPort("BaseTileServiceServicePort").binding.portType.addOperation(getTileById);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","getTileByIdResponse"),net.homeip.GetTileByIdResponse);
							SchemaTypeRegistry.getInstance().registerCollectionClass(new QName("http://tile.ws.editor.rpg.beacon.com/","getTilesByCategoryIdResponse"),net.homeip.GetTilesByCategoryIdResponse);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","getTileById"),net.homeip.GetTileById);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","updateTileByIdResponse"),net.homeip.UpdateTileByIdResponse);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","tile"),net.homeip.Tile);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","addTile"),net.homeip.AddTile);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","addTileResponse"),net.homeip.AddTileResponse);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","getTilesByCategoryId"),net.homeip.GetTilesByCategoryId);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://tile.ws.editor.rpg.beacon.com/","updateTileById"),net.homeip.UpdateTileById);
		}
		/**
