...
{
	/**
	 * A static class used for accessing the keyCodes or names of specific keys on the keyboard.
	 */
	public class Key 
	{
		// constants for the arrow keys
		public static const LEFT:int = 37;
		public static const UP:int = 38;
		public static const RIGHT:int = 39;
		public static const DOWN:int = 40;
		
		// constants for primary keyboard buttons
		...
		// constants for the keyboard letters
		...
		// constants for the function keys
